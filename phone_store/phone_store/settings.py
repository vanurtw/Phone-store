...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'store.context_processor.context_processor.form_sub_context',
            ],
        },
    },
]
...
EMAIL_HOST_USER = 'vawdanawuwadawdawa@aawdsifffgl.ru'
EMAIL_HOST_PASSWORD = 'wadawdaw2rrwafawfawsafagsgsegseges'
EMAIL_USE_SSL = True
EMAIL_PORT = 465
